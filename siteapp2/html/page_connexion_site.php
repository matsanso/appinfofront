...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($user['ban'] !== 'oui'){
    ...
    $error_msg = "vous n'etes pas authorisé. Veuillez contacter l'administrateur.";
  } else if ($user) {
    session_start();
  ...
  <body>
    ...
    <div id="container">
      ...
      <form method="POST">
        ...
        <input type="submit2" id='oubli' value='Mot de passe oublié ?' onclick="window.location.href='../html/mdpoubli.php'">
        </div>
